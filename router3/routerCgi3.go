...
func main() {
	...
	router, err := rest.MakeRouter(
		rest.Get("/cgi-bin/routerCgi2.cgi/getAllData", getAllData),
		rest.Get("/cgi-bin/routerCgi2.cgi/GetAWork/:request", GetAWork),
		rest.Post("/cgi-bin/routerCgi2.cgi/PostData", PostData),
		rest.Post("/cgi-bin/login.cgi/signup", signup),
		rest.Post("/cgi-bin/login.cgi/login", login),
	)
	if err != nil {
		log.Fatal(err)
	}
...
const filePath string = "./cgi-bin/" + "works3.json"
